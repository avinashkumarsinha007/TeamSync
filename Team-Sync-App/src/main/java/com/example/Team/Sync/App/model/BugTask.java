...
public class BugTask extends Task {
    ...
    public BugTask(Long id, Long projectId, String taskName, String taskDescription, Timestamp taskCreationDate, Timestamp taskStartDate, Timestamp taskEndDate, String taskStatus, Long taskCreatedBy, Date dueDate, String bugSpecificField) {
